...
general={
        ...
        'ignored':
         ...
         'not_implemented':
             [
               {'name':['pixel_types'], 'type':str, 'required':True},
               {'name':['filter_type'],'type':str,'required':False},
               {'name':['template_code_filename'], 'type':str, 'required':True},
               {'name':['output_image_type'],'type':str,'required':False},
               {'name':['vector_pixel_types_by_component'],'type':str,'required':False},
               {'name':['no_procedure'],'type':str,'required':False},
               {'name':['no_output_type'],'type':str,'required':False},
               {'name':['measurements'],'type':str,'required':False},
               {'name':['constant_type'],'type':str,'required':False},
               {'name':['pixel_types2'],'type':str,'required':False},
               {'name':['vector_pixel_types_by_component2'],'type':str,'required':False},
               {'name':['template_type'],'type':str,'required':False},
               {'name':['no_return_image'],'type':str,'required':False},
               {'name':['custom_type2'],'type':str,'required':False},
               {'name':['custom_register'],'type':str,'required':False},
               {'name':['long'],'type':int,'required':False},
               {'name':['output_pixel_type'],'type':str,'required':False},
               {'name':['additional_template_types'],'type':str,'required':False},
               {'name':['custom_set_input'],'type':str,'required':False}
             ]
...
members={
        ...
        'ignored':
         [
            ...
            {'name':['set_as_scalar']},  # The parameter values will be set individually, not altogether using the same scalar value
         ...
         'not_implemented':
         [
           {'name':['no_set_method'],'type':bool,'required':False },
           {'name':['dim_vec'],'type':int,'required':False },
           {'name':['custom_itk_cast'],'type':str,'required':False},
           {'name':['itk_type'],'type':str,'required':False},
           {'name':['pixeltype'],'type':str,'required':False},
           {'name':['point_vec'],'type':str,'required':False},
           {'name':['enum'],'type':list,'required':False}
         ]
      }
...
inputs={
        ...
        'processed':
         ...
         'not_implemented':
         [
           {'name':['no_size_check'],'type':str,'required':False},
           {'name':['custom_itk_cast'],'type':str,'required':False},
